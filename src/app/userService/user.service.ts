...
export class UserService {
  ...
  PATH_OF_API = 'https://api.algonexus.online';

  generateToken(email: string): Observable<any> {
    return this.httpClient.get(`https://api.algonexus.online/auth/generate-token/${email}`,);
  }


  unBlockUser(id: any) {
    return this.httpClient.get(`https://api.algonexus.online/auth/unBlock/${id}`);
  }

  blockUser(id: string) {
    return this.httpClient.get(`https://api.algonexus.online/auth/block/${id}`);
  }
