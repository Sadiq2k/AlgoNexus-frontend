...
export function updatePassword(http: HttpClient, rootUrl: string, params: UpdatePassword$Params, context?: HttpContext): Observable<StrictHttpResponse<UpdatePasswordResponse>> {
...
updatePassword.PATH = '/auth/update';
